      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="glass rounded-xl border border-[var(--border)] p-4 mt-4">
          <p className="text-xs text-center" style={{ color: 'var(--muted)' }}>
            🎓 This portal is exclusively for <strong className="text-white">SRM AP University</strong> students.
            Use your college email <strong className="text-white">firstname_lastname@srmap.edu.in</strong> to register.
          </p>
        </div>
