      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[var(--danger)] text-sm font-medium uppercase tracking-wider">Lost Items</span>
          </div>
          <h1 className="font-display text-4xl font-bold text-white">Help find these items</h1>
          <p className="text-[var(--muted)] mt-2">Browse all lost items reported on campus</p>
        </div>
        ...
        <div className="glass rounded-2xl border border-[var(--border)] p-4 mb-8 flex flex-wrap gap-3">
          <div className="relative flex-1 min-w-48">
            ...
            <input
              type="text" placeholder="Search lost items..."
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="font-display text-xl font-semibold text-white mb-2">No lost items found</h3>
            <p className="text-[var(--muted)] mb-4">Try different search terms or category</p>
                ...
                <div className="glass rounded-2xl border border-[var(--border)] overflow-hidden item-card"
                  ...
                  <div className="p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="badge-lost text-xs px-2.5 py-1 rounded-full font-medium">LOST</span>
